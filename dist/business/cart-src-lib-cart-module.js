...
CartPageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: CartPageComponent, selectors: [["lib-cart-page"]], decls: 19, vars: 11, consts: [[3, "cartData"], [1, "cart-list"], [1, "cart-list__header"], ["fxLayout", "row", "fxLayoutAlign", "space-between center"], ["mat-button", "", "color", "accent"], ["fxLayout", "row", "fxLayoutAlign", "start center", "fxLayoutGap", "2rem", 2, "margin-top", "20px"], ["type", "text", "id", "zipCode", 1, "zipcode", 3, "ngModel", "input", "ngModelChange"], [1, "ag-theme-alpine", "quotes-table", 2, "height", "800px", "width", "100%", "margin-top", "-50px", 3, "gridOptions", "rowData", "frameworkComponents", "pinnedBottomRowData", "defaultColDef", "columnDefs"], [1, "cart-list__payment"], ["fxLayout", "row", "fxLayoutAlign", "end end"], ["mat-flat-button", "", "color", "accent", 3, "disabled", "click"]], template: function CartPageComponent_Template(rf, ctx) { if (rf & 1) {
