...
class AddToQuoteComponent {
    constructor(_quoteListService, _user, _dialog, dialogData, _toaster, _dialogRef, _quoteService) {
...
AddToQuoteComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: AddToQuoteComponent, selectors: [["lib-add-to-quote"]], decls: 12, vars: 4, consts: [["fxLayout", "column", 1, "add-to-quote"], [1, "label", "pb_5"], ["fxLayout", "row", "fxLayoutGap", "1rem", "fxLayoutAlign", "start center"], [1, "add-to-quote-button", 3, "click"], ["src", "assets/shop/addButton.svg"], ["fxFlex", "", "appearance", "outline"], [3, "ngModel", "ngModelChange", "OnChanges"], [3, "value", 4, "ngFor", "ngForOf"], ["value", "", 4, "ngIf"], ["mat-flat-button", "", "color", "accent", 1, "add-button", "round_button", "label", 3, "disabled", "click"], [3, "value"], ["value", ""]], template: function AddToQuoteComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngModelChange", function AddToQuoteComponent_Template_mat_select_ngModelChange_7_listener($event) { return ctx.selectedQuote = $event; })("OnChanges", function AddToQuoteComponent_Template_mat_select_OnChanges_7_listener($event) { return ctx.changed($event); });
...
/* harmony import */ var projects_quote_src_lib_quote_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! projects/quote/src/lib/quote.service */ "qqH+");
/* harmony import */ var _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/flex-layout/flex */ "XiUz");
...
/* harmony import */ var _core_src_lib_cell_renderer_counter_counter_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../../../core/src/lib/cell-renderer/counter/counter.component */ "n7cx");
...
class ProductDetailsComponent {
    constructor(_dialog, data, moodboardService, _route, _user, _shopService, _toaster, _router, _location, dialogRef, coreService, _quoteService) {
        this._dialog = _dialog;
        this.data = data;
        this.moodboardService = moodboardService;
        this._route = _route;
